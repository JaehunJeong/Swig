...
<body>
<form name="frm" action="LectureApplyInsert2" method="post">
<div id="Level">
	<b>자신의 레벨을 알려주세요</b>
...
<div id="Carrer">
	<b>경력을 개월로 적어주세요.</b>
	<input type="text" placeholder="개월수" name="Carrer" value="" style="padding:7px;">개월
</div>
<div id="Comment">
	<b>튜터에게 전하는 말</b>
	<textarea rows="5" placeholder="튜터님에게 회원님에 대해 알려주세요.
	수업을 듣는 목적은 무엇인가요?
	튜터님의 어떤 점이 마음에 들어 신청하셨나요?" id="COMMENT" name="COMMENT"></textarea>
</div>
