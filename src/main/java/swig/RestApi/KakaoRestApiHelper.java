...
public class KakaoRestApiHelper {
   ...
   /* private static final String USER_SIGNUP_PATH = "/v1/user/signup";
    ...
    //카카오페이 api
    //결제 대기
    private static final String PAYMENT_READY = "/v1/payment/ready";
    //주문 상세 조회
    private static final String PAYMENT_ORDER = "/v1/payment/order";
    //주문 내역 조회
    ...
    public String signup(final Map<String, String> params) throws JsonGenerationException,JsonMappingException,IOException {
    ...
    public String updatProfile(final Map<String, String> params) throws JsonGenerationException,JsonMappingException,IOException {
	...
	// Kakao Pay
	///////////////////////////////////////////////////////////////
    public String requestPaymentReady(final Map<String, String> params) {
        return request(HttpMethodType.POST, PAYMENT_READY, mapToParams(params));
    }
    //String swig.RestApi.KakaoRestApiHelper.request(HttpMethodType httpMethod, String apiPath, String params)
    
    public String successPayment(final Map<String, String> params) {
    	return request(HttpMethodType.POST,PAYMENT_ORDER,mapToParams(params));
    }
    ...
    public String mapToJsonStr(Map<String, String > map) throws JsonGenerationException,JsonMappingException,IOException {
