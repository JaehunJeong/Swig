...
public class LectureController {
	...
	public ModelAndView CategoryList(CommandMap commandMap) throws Exception{
	  ...
	  List<Map<String,Object>> relist1=caList.get(0);
	  List<Map<String,Object>> relist2=caList.get(1);
	  List<Map<String,Object>> relist3=caList.get(2);
	  List<Map<String,Object>> relist4=caList.get(3);
	  List<Map<String,Object>> relist5=caList.get(4);
	  List<Map<String,Object>> relist6=caList.get(5);
	  List<Map<String,Object>> relist7=caList.get(6);
	  List<Map<String,Object>> relist8=caList.get(7);
	  List<Map<String,Object>> relist9=caList.get(8);
